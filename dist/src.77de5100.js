...
exports.move = move;
exports.turn = turn;
exports.MouldParticle = exports.turns = exports.degOfMv = exports.Dir = void 0;
...
var sin = Math.sin,
    ...
    flr = Math.floor;
var degOfMv = 16;
exports.degOfMv = degOfMv;

var turns = function turns(d) {
  return {
    left: (d + 1) % degOfMv,
...
var MouldParticle = function MouldParticle(x, y, n) {
  _classCallCheck(this, MouldParticle);
...
exports.MouldParticle = MouldParticle;

var _qc = function _qc(x, y, n, d) {
  var deltaA = TAU / degOfMv;
  var angle = n * deltaA;
...
function getNewPosition() {
  ...
  if (!((arguments.length <= 0 ? undefined : arguments[0]) instanceof MouldParticle)) {
    ...
    wid = arguments.length <= 3 ? undefined : arguments[3];
    hei = arguments.length <= 4 ? undefined : arguments[4];
    stepLen = arguments.length <= 5 ? undefined : arguments[5];
  } else {
    var ap = arguments.length <= 0 ? undefined : arguments[0];
    x = ap.x;
    y = ap.y;
    n = ap.facing;
    wid = arguments.length <= 1 ? undefined : arguments[1];
    hei = arguments.length <= 2 ? undefined : arguments[2];
    stepLen = arguments.length <= 3 ? undefined : arguments[3];
  }

  var _qc2 = _qc(x, y, n, stepLen),
      _qc3 = _slicedToArray(_qc2, 2),
      nX = _qc3[0],
      nY = _qc3[1];

  nX = (wid + nX) % wid;
  nY = (hei + nY) % hei;
  return (arguments.length <= 0 ? undefined : arguments[0]) instanceof MouldParticle ? new MouldParticle(nX, nY, n) : {
    x: nX,
    y: nY,
    facing: n
  };
...
function arrayStart(x, y, rad) {
  return 4 * (x + y * rad);
}

function sense(pcl, source, width, height, length) {
  var currentDirection = pcl.facing;

  var _turns = turns(currentDirection),
      left = _turns.left,
      right = _turns.right;

  var leftSensorLocation = getNewPosition(pcl.x, pcl.y, left, width, height, length);
  var rightSensorLocation = getNewPosition(pcl.x, pcl.y, right, width, height, length);
  var forwardSensorLocation = getNewPosition(pcl, width, height, length);

  var _map = [leftSensorLocation, forwardSensorLocation, rightSensorLocation].map(function (p) {
  ...
  var _map3 = [lVal, fVal, rVal].map(function (n) {
    return n > 200 ? 0 : n;
  });
  ...
  rVal = _map4[2];
  var move = true;
  var nDirection = currentDirection;
  if (fVal > lVal && fVal > rVal) move = true;else if (fVal < lVal && fVal < rVal) {
    move = false;
...
var _mouldUtils = require("./mouldUtils");

var rand = Math.random,
    flr = Math.floor;
var width = 512,
    height = 512;
var drawingCanvas = (0, _d.select)('body').append('canvas').style('width', width).style('height', height).attr('width', width).attr('height', height);
...
var gfx = drawingCanvas.node().getContext('2d');
gfx.fillStyle = 'black';
var startingData = gfx.getImageData(0, 0, width, height);
...
try {
  for (var _iterator = (0, _d.range)(width)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    var x = _step.value;
    ...
    try {
      for (var _iterator4 = (0, _d.range)(height)[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
        var y = _step4.value;
        var pos = (0, _mouldUtils.arrayStart)(x, y, width);
        var value = flr((0, _d.easeCircleInOut)(rand()) * 150);
...
var startingParticles = (0, _d.range)(0.08 * width * height).map(function (i) {
  var _ref = [flr(width * rand()), flr(height * rand())],
      ...
      y = _ref[1];
  var d = flr(rand() * 16);
  return new _mouldUtils.MouldParticle(x, y, d);
});
console.log(startingParticles);
var hcl2 = (0, _d.hcl)('#00f494');
var hcl1 = (0, _d.hcl)('#2f0a4a');
var hLerp = (0, _d.interpolate)(hcl1.h, hcl2.h);
var cLerp = (0, _d.interpolate)(hcl1.c, hcl2.c);
var lLerp = (0, _d.interpolate)(hcl1.l, hcl2.l);

var hclLerp = function hclLerp(t) {
  var h = hLerp(t);
  var c = cLerp(t);
  var l = lLerp(t);
  return (0, _d.hcl)(h, l, c);
};
...
var renderLoop = function renderLoop(t, data, pcls) {
  ...
  try {
    for (var _iterator2 = (0, _d.range)(width)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
      var x = _step2.value;
      ...
      try {
        for (var _iterator3 = (0, _d.range)(height)[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
          var y = _step3.value;
          var avg = 0;
          ...
          avg = flr(avg);
          data.data.set([avg, avg, avg, 255], (0, _mouldUtils.arrayStart)(x, y, width));
        }
      } catch (err) {
...
requestAnimationFrame(function () {
  return renderLoop(0, startingData, startingParticles);
});
},{"d3":"../node_modules/d3/index.js","./mouldUtils":"mouldUtils.ts"}]},{},["index.ts"], null)
